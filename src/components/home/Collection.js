        ...
        <>
            <Container className="text-center" fluid={true}>
                ...
                <Row>
                    ...
                    <Col className='p-0' xl={3} lg={3} md={3} sm={6} xs={6}>
                        <Card className='image-box card w-100'>
                            <img className='center w-75' src="https://rukminim2.flixcart.com/image/832/832/xif0q/shirt/m/s/o/m-usshto2367-u-s-polo-assn-original-imagsn4z32mdn8ru.jpeg?q=70" alt="" />
                            <Card.Body>
                                <p className='product-name-on-card'>Men Tailored Fit Printed Cut Away Collar Casual Shirt</p>
                                <p className='product-price-on-card'>Price: $150</p>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col className='p-0' xl={3} lg={3} md={3} sm={6} xs={6}>
                        <Card className='image-box card w-100'>
                            <img className='center w-75' src="https://rukminim2.flixcart.com/image/832/832/xif0q/shirt/4/0/7/-original-imags44yx8ez8m2r.jpeg?q=70" alt="" />
                            <Card.Body>
                                <p className='product-name-on-card'>Men Slim Fit Striped Formal Shirt</p>
                                <p className='product-price-on-card'>Price: $150</p>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col className='p-0' xl={3} lg={3} md={3} sm={6} xs={6}>
                        <Card className='image-box card w-100'>
                            <img className='center w-75' src="https://rukminim2.flixcart.com/image/832/832/xif0q/shirt/b/w/o/s-c301-white-dennis-lingo-original-imafw2ggrk5epcfu-bb.jpeg?q=70" alt="" />
                            <Card.Body>
                    ...
                    <Col className='p-0' xl={3} lg={3} md={3} sm={6} xs={6}>
                        <Card className='image-box card w-100'>
                            <img className='center w-75' src="https://rukminim2.flixcart.com/image/832/832/xif0q/shirt/n/f/q/-original-imagscygsaehn6uk.jpeg?q=70" alt="" />
                            <Card.Body>
                                <p className='product-name-on-card'>Men Slim Fit Printed Spread Collar Casual Shirt</p>
                                <p className='product-price-on-card'>Price: $150</p>
                            </Card.Body>
                        </Card>
                    </Col>
